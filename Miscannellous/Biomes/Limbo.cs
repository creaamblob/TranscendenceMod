...
namespace TranscendenceMod.Miscannellous.Biomes
{
    public class Limbo : ModBiome
    {
        ...
        {
            return ModContent.GetInstance<SpaceBlocksNearby>().SpaceBlocks >= 2500;
        }
        ...
        public override int Music => MusicLoader.GetMusicSlot("TranscendenceMod/Miscannellous/Assets/Sounds/Music/SilentScreams");
    }
