        ...
        public override void PostDrawInInventory(Item item, SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            if (Main.keyState.PressingShift())
            {
                ...
                switch (Modifier)
                {
                    ...
                    case ModifierIDs.DeathCharger: texString = "TranscendenceMod/Miscannellous/Assets/Icons/DeathCharger"; break;
                    ...
                    case ModifierIDs.IncompletePurity: texString = "TranscendenceMod/Miscannellous/Assets/Icons/IncompletePurity"; break;
                ...
                spriteBatch.Draw(sprite, position + new Vector2(5, 0), null, Color.White);
            }
        }
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            if (Modifier != 0 && item.ModItem is not BaseModifier)
            {
                ...
                switch (Modifier)
                {
                    ...
                    case ModifierIDs.DeathCharger: modifiername = Language.GetTextValue("Mods.TranscendenceMod.Messages.Tooltips.Modifiers.DeathCharger"); break;
