...
{
    public class SilverOre : BaseRecipeButton
    {
        ...
        public override int resultAmount => ProcessRecipes.SilverOre()[16];

        public override void OnClick()
        {
            for (int i = 0; i < 16; i++)
            {
                ProcesserUI.PreviewItems[i] = ProcessRecipes.SilverOre()[i];
            }
        }
    }
}