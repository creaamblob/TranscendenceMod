...
{
    public class CopperOre : BaseRecipeButton
    {
        ...
        public override int resultAmount => ProcessRecipes.CopperOre()[16];

        public override void OnClick()
        {
            for (int i = 0; i < 16; i++)
            {
                ProcesserUI.PreviewItems[i] = ProcessRecipes.CopperOre()[i];
            }
        }
    }
}