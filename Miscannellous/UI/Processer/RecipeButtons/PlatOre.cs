...
{
    public class PlatOre : BaseRecipeButton
    {
        ...
        public override int resultAmount => ProcessRecipes.PlatinumOre()[16];

        public override void OnClick()
        {
            for (int i = 0; i < 16; i++)
            {
                ProcesserUI.PreviewItems[i] = ProcessRecipes.PlatinumOre()[i];
            }
        }
    }
}