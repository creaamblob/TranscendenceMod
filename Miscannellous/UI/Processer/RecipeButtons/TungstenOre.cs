...
{
    public class TungstenOre : BaseRecipeButton
    {
        public override int ItemType => ItemID.TungstenOre;

        public override int xMod => 150;

        public override int yMod => 50;

        public override int resultAmount => ProcessRecipes.TungstenOre()[16];

        public override void OnClick()
        {
            for (int i = 0; i < 16; i++)
            {
                ProcesserUI.PreviewItems[i] = ProcessRecipes.TungstenOre()[i];
            }
        }
    }
}