...
{
    public class SpaceMonolithSky : CustomSky
    {
        ...
        {
            return Color.Lerp(Color.White * 0.2f, inColor, 1 - fadeIn);
        }
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            if (maxDepth >= 0 && minDepth < 0)
            {
                ...
                spriteBatch.Draw(sprite, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Color.White * fadeIn);
