...
namespace TranscendenceMod.Miscannellous.Skies
{
    public class NullSky : ModSurfaceBackgroundStyle
    {
        ...
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(ModContent.Request<Texture2D>($"Terraria/Images/Misc/VortexSky/Background").Value, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), new Color(0.75f, 0.75f, 0.75f, fade) * fade * 0.375f);
