...
{
    public class TitleMenuSeraph : ModSurfaceBackgroundStyle
    {
        ...
        private float BlackFade = 0.0025f;
        private Color Black;
        ...
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(sprite, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Color.White);

            spriteBatch.Draw(TextureAssets.BlackTile.Value, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Color.Black * 0.75f);
            ...
            eff.Parameters["uColor"].SetValue(new Vector3(0.25f, 0, 0.5f));

            eff.Parameters["uOpacity"].SetValue(8f);
            eff.Parameters["uImageSize0"].SetValue(new Vector2(Main.screenWidth, Main.screenHeight) * 0.5f);
            eff.Parameters["uTime"].SetValue(-Main.GlobalTimeWrappedHourly * -0.025f);
            ...
            for (int e = 0; e < 15; e++)
            {
                spriteBatch.Draw(stars, new Vector2(Main.screenWidth / 2, Main.screenHeight / 2), null, Color.White * 0.3f * (1f - (e / 15f)), -starsRot + MathHelper.ToRadians(e) - MathHelper.PiOver4, stars.Size() * 0.5f, 0.75f, SpriteEffects.None, 0);
            }

            spriteBatch.Draw(stars, new Vector2(Main.screenWidth / 2, Main.screenHeight / 2), null, Color.White, -starsRot, stars.Size() * 0.5f, 1f, SpriteEffects.None, 0);
