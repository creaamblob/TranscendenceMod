...
{
    public class SpaceBig01Natural : BaseBigRubble
    {
        public override string spritePath => "TranscendenceMod/Tiles/BigTiles/Rubbles/SpaceBig01";
    ...
    public class SpaceBig01RubbleMaker : BaseBigRubble
    {
        public override string spritePath => "TranscendenceMod/Tiles/BigTiles/Rubbles/SpaceBig01";
        public override int dustType => ModContent.DustType<SpaceRockDust>();
        public override Color mapColor => new Color(151, 89, 255);
