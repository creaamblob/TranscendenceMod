...
namespace TranscendenceMod.NPCs.Void
{
    public class LimboEyes : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            {
                new FlavorTextBestiaryInfoElement("The death of Moon Lord has influenced wild life around it, an example can be seen here as a spirit of a scorpion warped by the starly essence around itself."),
            });
        }
    }
}
