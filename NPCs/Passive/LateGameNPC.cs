    ...
    public class LateGameNPC : ModNPC
    {
        ...
        public override void AddShops()
        {
            var npcshop = new NPCShop(Type, ShopText);
            {
                ...
                TranscendenceUtils.sell(npcshop, ModContent.ItemType<ExtraTerrestrialString>(), Item.buyPrice(silver: 50));
                ...
                //Meteorite Ore 
                TranscendenceUtils.sell(npcshop, ItemID.Meteorite, Item.buyPrice(silver: 25), Condition.DownedSkeletron);
                //Angel-Horn Scythe
