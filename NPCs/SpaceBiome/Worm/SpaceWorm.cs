...
namespace TranscendenceMod.NPCs.SpaceBiome.Worm
{
    public class SpaceWorm_Head : HeadSegment
    {
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ItemID.LunarOre, 2, 12, 22));
            npcLoot.Add(ItemDropRule.Common(ItemID.FragmentSolar, 1, 4, 7));
            npcLoot.Add(ItemDropRule.Common(ItemID.FragmentVortex, 1, 4, 7));
            npcLoot.Add(ItemDropRule.Common(ItemID.FragmentNebula, 1, 4, 7));
            npcLoot.Add(ItemDropRule.Common(ItemID.FragmentStardust, 1, 4, 7));
