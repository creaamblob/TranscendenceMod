...
{
    public class VenomMosquito : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.friendly = false;
            NPC.value = Item.buyPrice(0, 0, 15);
        }
        ...
        {
            return SpawnCondition.SurfaceJungle.Chance * (NPC.downedMoonlord ? 0.85f : 0);
        }
        ...
        public override void AI()
        {
            ...
            void Throw()
            {
                TranscendenceUtils.BasicShotgun(NPC.GetSource_FromAI(), NPC.Center,
NPC.DirectionTo(player.Center), ModContent.ProjectileType<MosquitoPoison>(), (int)(NPC.damage * 0.66f), 0, 3, 55, 4, -1, 0, 1, 0);
            }
            ...
            void Dash()
            {
                ...
                TranscendenceUtils.ProjectileRing(NPC, 16, NPC.GetSource_FromAI(), NPC.Center,
                    ModContent.ProjectileType<MosquitoPoison>(), (int)(NPC.damage * 0.7f), 0, 1.25f, 0, 0, 0, -1, 0);
            }
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement(Language.GetTextValue("Mods.TranscendenceMod.Messages.Bestiary.VenomMosquito")),
            });
        }
