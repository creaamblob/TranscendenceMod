...
namespace TranscendenceMod.Projectiles.Weapons
{
    public class ElementalArrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 275 && npc == null)
            {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (npc == null)
            {
                TranscendenceUtils.DrawProjAnimated(Projectile, Color.Gray * 0.5f, Projectile.scale, $"{Texture}", Projectile.rotation, new Vector2(0, -15), true, false, true);
            }
            ...
            TranscendenceUtils.DrawEntity(Projectile, Color.White * 0.8f, Projectile.scale * 0.5f, "TranscendenceMod/Miscannellous/Assets/Slash",
                Projectile.rotation, Projectile.Center + Vector2.One.RotatedBy(Projectile.velocity.ToRotation() - MathHelper.PiOver4) * 10, null);

            TranscendenceUtils.DrawEntity(Projectile, Color.White * 0.8f, Projectile.scale * 0.33f, "TranscendenceMod/Miscannellous/Assets/Slash",
