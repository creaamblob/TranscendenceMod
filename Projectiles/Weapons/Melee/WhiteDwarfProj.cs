...
namespace TranscendenceMod.Projectiles.Weapons.Melee
{
    public class WhiteDwarfProj : ModProjectile
    {
        ...
        {
            Asset<Texture2D> sprite = ModContent.Request<Texture2D>($"{Texture}_Extension");

            Vector2 ownerPos = player.MountedCenter;
            Vector2 pos = Projectile.Center;
            Vector2 angleToOwner = ownerPos - pos;

            float extenderRot = angleToOwner.ToRotation() - MathHelper.PiOver2;
            float distance = angleToOwner.Length();
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            TranscendenceUtils.DrawEntity(Projectile, Color.HotPink * 0.66f, 2.15f, "TranscendenceMod/Miscannellous/Assets/GlowBloomNoBG",
