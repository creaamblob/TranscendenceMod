...
namespace TranscendenceMod.Projectiles.NPCs.Bosses.SpaceBoss
{
    public class HomingStarLaser : ModProjectile
    {
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            if (Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), ChosenNPC.Center, ChosenNPC.Center + Vector2.One.RotatedBy(rot + MathHelper.PiOver4 * Projectile.ai[0]) * 2000, 12 * Projectile.scale, ref reference))
                return true;
            else return false;
        }
