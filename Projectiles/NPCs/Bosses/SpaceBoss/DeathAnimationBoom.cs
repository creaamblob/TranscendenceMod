...
{
    public class DeathAnimationBoom : ModProjectile
    {
        ...
        public override void OnSpawn(IEntitySource source) => SoundEngine.PlaySound(SoundID.DD2_KoboldExplosion with { MaxInstances = 0, Volume = 0.6f }, Projectile.Center);
