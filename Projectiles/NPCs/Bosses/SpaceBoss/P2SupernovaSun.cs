...
namespace TranscendenceMod.Projectiles.NPCs.Bosses.SpaceBoss
{
    public class P2SupernovaSun : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            ArtificialSun.DrawBreathingStar(Projectile, Projectile.scale, spriteBatch);
            return false;
        }
        ...
        public override bool PreKill(int timeLeft)
        {
            ...
            if (npc != null && npc.active && npc.ModNPC is CelestialSeraph boss)
            {
                ...
                for (int i = 0; i < 256; i++)
                {
                    int p2 = Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2Circular(48f, 48f), ModContent.ProjectileType<P2SupernovaProj>(), 80, 0f, -1, 0, Projectile.ai[1]);
