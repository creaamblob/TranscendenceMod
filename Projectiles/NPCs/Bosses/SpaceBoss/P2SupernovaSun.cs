...
namespace TranscendenceMod.Projectiles.NPCs.Bosses.SpaceBoss
{
    public class P2SupernovaSun : ModProjectile
    {
        ...
        public override bool PreKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 256; i++)
            {
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2Circular(48f, 48f), ModContent.ProjectileType<P2SupernovaProj>(), 80, 0f, -1, 0, Projectile.ai[1]);
            }
