    ...
    public class Meteor : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.Distance(pos) < 25)
            {
                ...
                int p = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<SpaceBossBombBlast>(), 80, 2f, -1, 1f, Projectile.ai[1], 0.825f);
