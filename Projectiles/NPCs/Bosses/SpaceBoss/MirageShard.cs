...
{
    public class MirageShard : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (!Main.getGoodWorld && !Main.zenithWorld && Projectile.ai[0] == 0)
            {
                ...
                Main.spriteBatch.Draw(sprite, rec, null, Color.HotPink * 0.75f, Projectile.rotation, sprite.Size() * 0.5f, SpriteEffects.None, 0);
                Main.spriteBatch.Draw(sprite2, rec2, null, new Color(200, 0, 40) * Alpha, Projectile.rotation, sprite2.Size() * 0.5f, SpriteEffects.None, 0);
                /*
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (++Timer2 > 40)
                    Projectile.GetGlobalProjectile<TranscendenceProjectiles>().baseVel = Projectile.GetGlobalProjectile<TranscendenceProjectiles>().baseVel.RotatedBy(0.025f * (Projectile.GetGlobalProjectile<TranscendenceProjectiles>().baseVel.X / -10f));
            }
