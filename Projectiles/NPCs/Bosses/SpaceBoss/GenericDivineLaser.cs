...
namespace TranscendenceMod.Projectiles.NPCs.Bosses.SpaceBoss
{
    public class GenericDivineLaser : ModProjectile
    {
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            if (Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), Center, Projectile.Center + Vector2.One.RotatedBy(rot) * 2000, (int)(10 * Projectile.ai[2] * Projectile.scale), ref reference))
                return true;
            else return false;
        }
