...
namespace TranscendenceMod.Projectiles.NPCs.Bosses.Nucleus
{
    public class NucleusTarget : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            TranscendenceUtils.DrawEntity(Projectile, Color.White, Projectile.scale, TranscendenceMod.ASSET_PATH + "/GrazeCircle", Main.GlobalTimeWrappedHourly, Projectile.Center, null);
