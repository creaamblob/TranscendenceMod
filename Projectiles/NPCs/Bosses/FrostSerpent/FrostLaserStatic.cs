...
{
    public class FrostLaserStatic : ModProjectile
    {
        public float rot;
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 180 && ChosenNPC != null && ChosenNPC.active)
            {
            ...
            if (Projectile.timeLeft < 140 && Projectile.timeLeft > 30 && Projectile.scale < 1f)
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            if (Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), Center, Center + Vector2.One.RotatedBy(rot) * 2000, 50, ref reference))
                return true;

            else return false;
        }
        public override bool? CanDamage() => Projectile.timeLeft < 120 && Projectile.timeLeft > 15;
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            eff.Parameters["uImageSize0"].SetValue(shaderImage.Size() * (1f + shaderRot));
            ...
            eff.Parameters["uDirection"].SetValue(shaderRot);
            ...
            sb.Draw(sprite, new Rectangle(
                (int)(pos.X - Main.screenPosition.X), (int)(pos.Y - Main.screenPosition.Y), (int)(300 * Projectile.scale), (int)(pos.Distance(pos2) * 2f)), null,
            ...
            {
                sb.Draw(sprite, new Rectangle(
                    (int)(pos.X - Main.screenPosition.X), (int)(pos.Y - Main.screenPosition.Y), (int)(120 * Projectile.scale), (int)(pos.Distance(pos2) * 2f)), null,
