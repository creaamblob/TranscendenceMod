...
namespace TranscendenceMod.Projectiles.NPCs
{
    public class TwistedTendril : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 6; i++)
            {
                Dust.NewDust(Projectile.position, 4, 4, ModContent.DustType<VoidDust>(), Main.rand.NextFloat(), Main.rand.NextFloat());
            }
        }
        ...
        public override void AI()
        {
            ...
            if (++Timer % 1 == 0)
            {
                ...
                int d = Dust.NewDust(pos1, 1, 1, ModContent.DustType<VoidDust>(), 0, 0, 0, Color.White, 1f);
                ...
                int d2 = Dust.NewDust(pos2, 1, 1, ModContent.DustType<VoidDust>(), 0, 0, 0, Color.White, 1f);
