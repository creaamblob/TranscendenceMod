...
{
    public class SuperBombProj_Brick : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<SuperCreation>(), 200, Projectile.knockBack, Projectile.owner, 0, Projectile.ai[1]);
