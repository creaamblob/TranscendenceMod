...
namespace TranscendenceMod.Items.Consumables.LootBags
{
    public class CelestialSeraphBag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<ShimmerChunk>(), 1, 16, 20));

            itemLoot.Add(ItemDropRule.FewFromOptions(5, 1, ModContent.ItemType<WhiteDwarf>(),
                ModContent.ItemType<Stargazer>(), ModContent.ItemType<CelestialSeraphStaff>(), ModContent.ItemType<Constellations>(),
