...
namespace TranscendenceMod.Items.NPCShops
{
    ...
    {
        public int proj = ModContent.ProjectileType<BasicSword_Proj>();
    ...
    public class BasicSword_Proj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            TranscendenceUtils.DrawProjAnimated(Projectile, Color.White * (Projectile.ai[1] / 15f), Projectile.scale, $"{Texture}", Projectile.rotation, Projectile.Center, false, false, false);
            return false;
        }
        public override void AI()
        {
            ...
            {
                player.GetModPlayer<TranscendencePlayer>().SwordTimer = 10;
            }
