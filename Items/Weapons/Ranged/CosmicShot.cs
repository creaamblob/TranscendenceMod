...
{
    public class CosmicShot : ModItem
    {
        ...
        {
            Projectile.NewProjectile(source, position, velocity * 2.25f, ModContent.ProjectileType<GodlyTendril>(), damage, knockback, player.whoAmI, 1f);
            Projectile.NewProjectile(source, position, velocity * 2.25f, ModContent.ProjectileType<GodlyTendril>(), damage, knockback, player.whoAmI, -1f);
